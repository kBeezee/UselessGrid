...
myObjects.Player(fftSpirteSheet.images_at(fftWalkingLoop, "sprite",  colorkey=fftSpirteSheet.ColorKey), 416, 160, "p1")
...
tileset += TilesFileOne.images_at(blocks, "tile", colorkey=TilesFileOne.ColorKey)
...
tileset += TilesFileTwo.images_at(blocks, "tile", colorkey=(0, 0, 0))
